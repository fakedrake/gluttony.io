...
Two middleware functions are provided by default in the `gluttony.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `gluttony.handler` namespace to manage the enabled middleware.
